...
openai.api_key = "YourOpenAIKeyHere"
# Placeholder for the input folder
folder_path = "PathToYourAudioFiles"
# Placeholder for the output folder
output_path = "PathToYourOutputFiles"
...
def generate_summary(text, prompt, max_tokens=50):
...
def generate_headline(text, max_tokens=20):
    ...
    headline = response.choices[0].text.strip().strip('"')  # added .strip('"') to remove quotation marks
    return headline
        ...
        while True:
            for entry in os.scandir(folder_path):
                if (
                    ...
                    # Generate the summary of the recording using text-davinci-003 from the transcript
